 ...
 *        Module: render
 *          File:
 * Functionality: handle the viewpoint of video.
 *       Related:
 *        System: android
 *      Language: C++
 *        Author: huangxuefeng
...
#ifndef _PAOMIANTV_VIDEO_GEOMETRY_H_
#define _PAOMIANTV_VIDEO_GEOMETRY_H_
/*!
        ...
        Quadrangle<DECIMAL> & interest)
{
    ...
    if (fw_x_vh >= vw_x_fh)
    {
        ...
        // aspect.ferquency = fw_x_vh / frame.height;
    ...
    {
        // aspect.ferquency = view.ferquency;
        // aspect.height = vw_x_fh / frame.ferquency;
...
#endif // _PAOMIANTV_VIDEO_GEOMETRY_H_