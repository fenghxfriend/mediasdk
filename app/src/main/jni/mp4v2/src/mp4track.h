...
public:
    ...
    MP4SampleId GetNextSyncSampleIdFromTime(
            MP4Timestamp when);
    MP4SampleId GetPreviousSyncSampleIdFromTime(
            MP4Timestamp when);

    void GetSyncSampleIds(
...
protected:
    ...
    MP4SampleId GetPreviousSyncSample(MP4SampleId sampleId);
