...
public:
    ...
    MP4SampleId GetNextSyncSampleIdFromTime(MP4TrackId trackId,
                                                     MP4Timestamp when);
    MP4SampleId GetPreviousSyncSampleIdFromTime(MP4TrackId trackId,
                                                         MP4Timestamp when);
    void GetSyncSampleIds(MP4TrackId trackId, MP4SampleId** ppIds,uint32_t* pSize);
