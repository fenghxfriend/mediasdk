 ...
 * with the recommended scaling.  (To scale up 12-bit sample task further, an
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  int ctr;
  int workspace[DCTSIZE2];      /* buffers task between passes */
  SHIFT_TEMPS
               ...
               JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[7*7];   /* buffers task between passes */
  SHIFT_TEMPS
               ...
               JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[6*6];   /* buffers task between passes */
  SHIFT_TEMPS
               ...
               JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[5*5];   /* buffers task between passes */
  SHIFT_TEMPS
               ...
               JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[3*3];   /* buffers task between passes */
  SHIFT_TEMPS
               ...
               JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*9];   /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*10];  /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*11];  /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*12];  /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*13];  /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*14];  /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*15];  /* buffers task between passes */
  SHIFT_TEMPS
                 ...
                 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  int workspace[8*16];  /* buffers task between passes */
  SHIFT_TEMPS
