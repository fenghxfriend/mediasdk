...
/* Derived task constructed for each Huffman table */
...
typedef struct {
   ...
   * the input task stream.  If the next Huffman code is no more
 ...
 * 1. Near the end of the task segment, we may fail to get enough bits
