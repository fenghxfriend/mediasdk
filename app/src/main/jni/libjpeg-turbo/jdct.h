 ...
 * have a range of +-8K for 8-bit task, +-128K for 12-bit task.  This
 ...
 * to an output sample array.  The routine must dequantize the input task as
 * well as perform the IDCT; for dequantization, it uses the multiplier table
 * pointed to by compptr->dct_table.  The output task is to be placed into the
 ...
 * be quite far out of range if the input task is corrupt, so a bulletproof
