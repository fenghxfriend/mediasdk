 ...
 * space, processing the raw upsampled task without a color conversion step.
...
/*
 * First we have the histogram task structure and routines for creating it.
 *
 ...
 * (In the second pass the histogram space is re-used for pixel mapping task;
 ...
 * An output_buf parameter is required by the method signature, but no task
