...
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_clearBytes(
...
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setup(
...
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_finish(
...
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_putBytes(
...
extern "C" DLL_PUBLIC jint Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_getBytes(
...
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setPitchSemi(
        JNIEnv *env, jobject thiz, jint track, jfloat pitchSemi) {
    SoundTouchStream& soundTouch = stStreams.at(track);
    setPitchSemi(soundTouch, pitchSemi);
}
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setTempo(
        JNIEnv *env, jobject thiz, jint track, jfloat tempo) {
    SoundTouchStream& soundTouch = stStreams.at(track);
    setTempo(soundTouch, tempo);
}
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setRate(
        JNIEnv *env, jobject thiz, jint track, jfloat rate) {
    SoundTouchStream& soundTouch = stStreams.at(track);
    setRate(soundTouch, rate);
}
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setRateChange(
        JNIEnv *env, jobject thiz, jint track, jfloat rateChange) {
    SoundTouchStream& soundTouch = stStreams.at(track);
    setRateChange(soundTouch, rateChange);
}
extern "C" DLL_PUBLIC jlong Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_getOutputBufferSize(
        JNIEnv *env, jobject thiz, jint track) {
    SoundTouchStream& soundTouch = stStreams.at(track);
    queue<jbyte>* byteBufferOut = soundTouch.getStream();
    return byteBufferOut->size();
}
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setTempoChange(
        JNIEnv *env, jobject thiz, jint track, jfloat tempoChange) {
    SoundTouchStream& soundTouch = stStreams.at(track);
    setTempoChange(soundTouch, tempoChange);
}
extern "C" DLL_PUBLIC void Java_cn_paomiantv_mediasdk_media_audio_SoundTouch_setSpeech(
